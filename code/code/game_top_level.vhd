...
architecture wiring of game_top_level is
	...
	signal internal_button_0, internal_button_1, internal_button_2 : std_logic;
...
begin
	...
	-- Clock divider: 50MHz -> 25MHz for VGA
	process(CLOCK_50)
	begin
	...
	-- Invert active-low buttons to active-high
	...
	-- Gate vert_sync with SW(9) for pause - when SW(9) is high, ball freezes
	vert_sync_gated <= vert_sync_internal AND (NOT SW(9));
	...
	-- Convert ball Y position to BCD digits for seven segment display
	...
	-- Seven segment display: show ball Y position (hundreds, tens, ones)
